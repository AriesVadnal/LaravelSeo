...
class PostController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success','Postingan anda berhasil dihapus ( silahkan check di trash)');
    }
    ...
    public function restore($id) {
        ...
        return redirect()->back()->with('success','Postingan anda berhasil di return ( silahkan check di post)');
    }
    ...
    public function kill($id) {
        ...
        return redirect()->back()->with('success','Postingan anda berhasil di dihapus secara permanen');
    }
}
